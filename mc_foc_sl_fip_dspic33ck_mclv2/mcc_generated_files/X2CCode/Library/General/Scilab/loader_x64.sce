...
//
[bOK, ilib] = c_link('x2c_LookupTable1_FiP16_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_LookupTable1_FiP32_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_LookupTable1_Float32_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_LookupTable1_Float64_C');
if bOK then
  ulink(ilib);
end
//
