...
function [x_sci,y_sci,typ_sci] = x2c_Clarke_inv_M(job, arg1, arg2)

thisBlockData.Library = "MCHP";
thisBlockData.block_type_name = "Clarke_inv_MCHP";
thisBlockData.block_xcosfilename = "x2c_Clarke_inv_M";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Clarke_inv_M_"  + used_impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Clarke_inv_M_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + strsubst(pwd(), "\", "/") + "/../Doc/Images/Clark_inv.png"
