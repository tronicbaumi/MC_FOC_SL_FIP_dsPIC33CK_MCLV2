...
//
[bOK, ilib] = c_link('x2c_BEMF_PLL_MCH_FiP16_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_BEMF_PLL_MCH_FiP32_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_BEMF_PLL_MCH_Float32_C');
if bOK then
  ulink(ilib);
end
//
