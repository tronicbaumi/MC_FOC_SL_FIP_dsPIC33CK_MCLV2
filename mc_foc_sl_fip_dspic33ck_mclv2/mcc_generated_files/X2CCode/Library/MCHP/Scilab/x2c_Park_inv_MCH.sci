...
function [x_sci,y_sci,typ_sci] = x2c_Park_inv_MCH(job, arg1, arg2)

thisBlockData.Library = "MCHP";
thisBlockData.block_type_name = "Park_inv_MCHP";
thisBlockData.block_xcosfilename = "x2c_Park_inv_MCH";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Park_inv_MCH_"  + used_impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Park_inv_MCH_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + strsubst(pwd(), "\", "/") + "/../Doc/Images/Park_inv.png"
