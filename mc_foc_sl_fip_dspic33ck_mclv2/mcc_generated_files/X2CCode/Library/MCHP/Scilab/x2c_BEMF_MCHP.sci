// This file was generated by createIFunction.sci on 09-03-2022 08:46

function [x_sci,y_sci,typ_sci] = x2c_BEMF_MCHP(job, arg1, arg2)

thisBlockData.Library = "MCHP";
thisBlockData.block_type_name = "BEMF_MCHP";
thisBlockData.block_xcosfilename = "x2c_BEMF_MCHP";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_BEMF_MCHP_"  + used_impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_BEMF_MCHP_"  + used_impl + "_C", 4);
