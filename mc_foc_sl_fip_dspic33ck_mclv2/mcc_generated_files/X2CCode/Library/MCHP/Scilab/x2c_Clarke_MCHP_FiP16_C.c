...
#include <Clarke_MCHP_FiP16.h>
#include <Clarke_MCHP_FiP16.c>
...
/* */
void x2c_Clarke_MCHP_FiP16_C(scicos_block* block, scicos_flag flag);
static void x2c_Clarke_MCHP_FiP16_C__OutputUpdate(scicos_block* block);
static void x2c_Clarke_MCHP_FiP16_C__StateUpdate(scicos_block* block);
static void x2c_Clarke_MCHP_FiP16_C__Initialization(scicos_block* block);
static void x2c_Clarke_MCHP_FiP16_C__Ending(scicos_block* block);
...
void x2c_Clarke_MCHP_FiP16_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_Clarke_MCHP_FiP16_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_Clarke_MCHP_FiP16_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_Clarke_MCHP_FiP16_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_Clarke_MCHP_FiP16_C__Ending(block);
            break;
        }
...
static void x2c_Clarke_MCHP_FiP16_C__set_parameter(scicos_block* block, CLARKE_MCHP_FIP16 *blockParam) {
    int *paramI;
    double *paramR;
    CLARKE_MCHP_FIP16 *pTClarke_MCHP_FiP16;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTClarke_MCHP_FiP16 = GetWorkPtrs(block);
}
...
static void x2c_Clarke_MCHP_FiP16_C__Initialization(scicos_block* block) {
    ...
    /* *** */
    pTClarke_MCHP_FiP16 = scicos_malloc(sizeof(CLARKE_MCHP_FIP16));
    GetWorkPtrs(block) = pTClarke_MCHP_FiP16;
    x2c_Clarke_MCHP_FiP16_C__set_parameter(block, pTClarke_MCHP_FiP16);

    /* Assignment of inports */
    inport_a_p = GetInPortPtrs(block, 1);
    inport_a = convert_double_to_Q15(*inport_a_p);
    pTClarke_MCHP_FiP16->a = &inport_a;
    inport_b_p = GetInPortPtrs(block, 2);
    inport_b = convert_double_to_Q15(*inport_b_p);
    pTClarke_MCHP_FiP16->b = &inport_b;

    /* Assignment of parameter arrays */
    arrayStart = 0;

    /* Initialization */
    Clarke_MCHP_FiP16_Init(pTClarke_MCHP_FiP16);

    /* Assignment of outports */
    outport_alpha = GetOutPortPtrs(block, 1);
    *outport_alpha = convert_Q15_to_double(pTClarke_MCHP_FiP16->alpha);
    outport_beta = GetOutPortPtrs(block, 2);
    *outport_beta = convert_Q15_to_double(pTClarke_MCHP_FiP16->beta);
...
static void x2c_Clarke_MCHP_FiP16_C__Ending(scicos_block* block) {
    CLARKE_MCHP_FIP16 *pTClarke_MCHP_FiP16;
    pTClarke_MCHP_FiP16 = GetWorkPtrs(block);
    scicos_free(pTClarke_MCHP_FiP16);
}


static void x2c_Clarke_MCHP_FiP16_C__StateUpdate_f(scicos_block* block) {
...
static void x2c_Clarke_MCHP_FiP16_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_Clarke_MCHP_FiP16_C__StateUpdate_f(block);
    }
}
...
static void x2c_Clarke_MCHP_FiP16_C__OutputUpdate(scicos_block* block) {
    ...
    /* Update */
    Clarke_MCHP_FiP16_Update(pTClarke_MCHP_FiP16);
