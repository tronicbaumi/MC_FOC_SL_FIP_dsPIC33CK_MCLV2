...
/* */
void x2c_BEMF_MCHP_FiP16_C(scicos_block* block, scicos_flag flag);
static void x2c_BEMF_MCHP_FiP16_C__OutputUpdate(scicos_block* block);
static void x2c_BEMF_MCHP_FiP16_C__StateUpdate(scicos_block* block);
static void x2c_BEMF_MCHP_FiP16_C__Initialization(scicos_block* block);
static void x2c_BEMF_MCHP_FiP16_C__Ending(scicos_block* block);
...
void x2c_BEMF_MCHP_FiP16_C(scicos_block* block, scicos_flag flag) {
    ...
    switch (flag) {
        ...
        case OutputUpdate:     /* 1 */
        {
            x2c_BEMF_MCHP_FiP16_C__OutputUpdate(block);
            break;
        }
        case StateUpdate:      /* 2 */
        {
            x2c_BEMF_MCHP_FiP16_C__StateUpdate(block);
            break;
        }
        ...
        {
            x2c_BEMF_MCHP_FiP16_C__Initialization(block);
            break;
        }
        case Ending:           /* 5 */
        {
            x2c_BEMF_MCHP_FiP16_C__Ending(block);
            break;
        }
...
static void x2c_BEMF_MCHP_FiP16_C__set_parameter(scicos_block* block, BEMF_MCHP_FIP16 *blockParam) {
    int *paramI;
    double *paramR;
    BEMF_MCHP_FIP16 *pTBEMF_MCHP_FiP16;
    
    /* *** */
    paramI = GetIparPtrs(block);  /* integer parameters  */
    paramR = GetRparPtrs(block);  /* real parameters     */
    pTBEMF_MCHP_FiP16 = GetWorkPtrs(block);
...
static void x2c_BEMF_MCHP_FiP16_C__Ending(scicos_block* block) {
    BEMF_MCHP_FIP16 *pTBEMF_MCHP_FiP16;
    pTBEMF_MCHP_FiP16 = GetWorkPtrs(block);
    scicos_free(pTBEMF_MCHP_FiP16);
}


static void x2c_BEMF_MCHP_FiP16_C__StateUpdate_f(scicos_block* block) {
    BEMF_MCHP_FIP16 *pTBEMF_MCHP_FiP16;
    int16 arrayStart = 0;
    ...
    /* Update */
    BEMF_MCHP_FiP16_Update(pTBEMF_MCHP_FiP16);
...
static void x2c_BEMF_MCHP_FiP16_C__StateUpdate(scicos_block* block) {
    if (GetNevIn(block) > 0) {
        ...
        */
        x2c_BEMF_MCHP_FiP16_C__StateUpdate_f(block);
    }
}
