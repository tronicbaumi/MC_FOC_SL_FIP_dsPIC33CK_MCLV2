...
function [x_sci,y_sci,typ_sci] = x2c_Clarke_MCHP(job, arg1, arg2)

thisBlockData.Library = "MCHP";
thisBlockData.block_type_name = "Clarke_MCHP";
thisBlockData.block_xcosfilename = "x2c_Clarke_MCHP";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Clarke_MCHP_"  + used_impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Clarke_MCHP_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + strsubst(pwd(), "\", "/") + "/../Doc/Images/Clark.png"
