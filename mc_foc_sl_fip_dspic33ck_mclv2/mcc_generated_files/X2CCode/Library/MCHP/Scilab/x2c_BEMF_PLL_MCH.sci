// This file was generated by createIFunction.sci on 04-05-2023 23:15

function [x_sci,y_sci,typ_sci] = x2c_BEMF_PLL_MCH(job, arg1, arg2)

thisBlockData.Library = "MCHP";
thisBlockData.block_type_name = "BEMF_PLL_MCHP";
thisBlockData.block_xcosfilename = "x2c_BEMF_PLL_MCH";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_BEMF_PLL_MCH_"  + used_impl + "_C", 4);
...
//Rs_val = exprs(14);
// R and L value
myStyle = "noLabel=0;displayedLabel=R=%14$sOhm<br/>L=%10$smH;"
myStyle = myStyle + "verticalAlign=bottom;" // place to the bottom
myStyle = myStyle + "fontSize=14;" // Text little bit bigger

define_style = myStyle;
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_BEMF_PLL_MCH_"  + used_impl + "_C", 4);
...
//style_tmp.rounded = 1; // Block edges rounded
//style_tmp.fillColor = "#FFB9B7"; // Upper color
//style_tmp.gradientColor = "#CE635E"; // Lower color
//Background image
style_tmp.image = "file:///" + strsubst(pwd(), "\", "/") + "/../Doc/Images/BEMF_calc.png";
