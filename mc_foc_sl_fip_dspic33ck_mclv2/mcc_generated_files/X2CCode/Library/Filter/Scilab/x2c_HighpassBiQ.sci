...
function [x_sci,y_sci,typ_sci] = x2c_HighpassBiQ(job, arg1, arg2)

thisBlockData.Library = "Filter";
thisBlockData.block_type_name = "HighpassBiQ";
thisBlockData.block_xcosfilename = "x2c_HighpassBiQ";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_HighpassBiQ_"  + used_impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_HighpassBiQ_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + pwd() + "/../../Filter/Doc/Images/Highpass.svg"
