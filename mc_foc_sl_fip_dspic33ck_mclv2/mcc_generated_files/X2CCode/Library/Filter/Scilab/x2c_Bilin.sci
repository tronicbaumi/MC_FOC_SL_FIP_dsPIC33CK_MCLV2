...
function [x_sci,y_sci,typ_sci] = x2c_Bilin(job, arg1, arg2)

thisBlockData.Library = "Filter";
thisBlockData.block_type_name = "Bilin";
thisBlockData.block_xcosfilename = "x2c_Bilin";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Bilin_"  + used_impl + "_C", 4);
...
define_style = "noLabel=0;displayedLabel=b<sub>0</sub> + b<sub>1</sub>z<sup>-1</sup><br>------------<br>&nbsp<sub>&nbsp</sub>1 + a<sub>1</sub>z<sup>-1</sup>";
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Bilin_"  + used_impl + "_C", 4);
