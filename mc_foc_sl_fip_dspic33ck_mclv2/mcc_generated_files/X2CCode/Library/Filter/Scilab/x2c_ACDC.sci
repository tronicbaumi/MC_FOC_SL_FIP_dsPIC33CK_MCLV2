...
function [x_sci,y_sci,typ_sci] = x2c_ACDC(job, arg1, arg2)

thisBlockData.Library = "Filter";
thisBlockData.block_type_name = "ACDC";
thisBlockData.block_xcosfilename = "x2c_ACDC";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_ACDC_"  + used_impl + "_C", 4);
...
define_out_style = ["fontColor=#0000FF";"fontColor=#808080"]; //blue:#0000FF, grey:#808080
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_ACDC_"  + used_impl + "_C", 4);
