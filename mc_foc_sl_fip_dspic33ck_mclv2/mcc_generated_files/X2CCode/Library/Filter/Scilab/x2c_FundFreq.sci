...
function [x_sci,y_sci,typ_sci] = x2c_FundFreq(job, arg1, arg2)

thisBlockData.Library = "Filter";
thisBlockData.block_type_name = "FundFreq";
thisBlockData.block_xcosfilename = "x2c_FundFreq";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_FundFreq_"  + used_impl + "_C", 4);
...
define_out_style = "fontColor=blue";
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_FundFreq_"  + used_impl + "_C", 4);
