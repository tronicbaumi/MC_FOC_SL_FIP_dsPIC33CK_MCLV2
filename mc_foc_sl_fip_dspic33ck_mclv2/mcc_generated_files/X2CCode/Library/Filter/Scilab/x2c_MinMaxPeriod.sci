...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_MinMaxPeriod_"  + used_impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_MinMaxPeriod_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + X2CRootDir + "Library/Filter/Doc/Images/MinMaxPeriodic.svg"
