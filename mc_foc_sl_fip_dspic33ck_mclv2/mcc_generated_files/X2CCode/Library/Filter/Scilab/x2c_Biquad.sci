// This file was generated by createIFunction.sci on 30-08-2023 03:27

function [x_sci,y_sci,typ_sci] = x2c_Biquad(job, arg1, arg2)

thisBlockData.Library = "Filter";
thisBlockData.block_type_name = "Biquad";
thisBlockData.block_xcosfilename = "x2c_Biquad";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_Biquad_"  + used_impl + "_C", 4);
...
define_style = "noLabel=0;displayedLabel=b<sub>0</sub> + b<sub>1</sub>z<sup>-1</sup> + b<sub>2</sub>z<sup>-2</sup><br>---------------------<br>&nbsp<sub>&nbsp</sub>1 + a<sub>1</sub>z<sup>-1</sup> + a<sub>2</sub>z<sup>-2</sup>";
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_Biquad_"  + used_impl + "_C", 4);
