...
public class ConvFnc_IIR_Float64 extends JavaConversionFunction {
...
// USERCODE-BEGIN:ConvImplementationToMask                                                                              
        if (true) {
            throw new Exception(
                    "Implementation-to-Mask conversion not implemented for Block 'IIR', Implementation 'Float64' in Library 'Filter' due to ambiguous parameters");
        }
