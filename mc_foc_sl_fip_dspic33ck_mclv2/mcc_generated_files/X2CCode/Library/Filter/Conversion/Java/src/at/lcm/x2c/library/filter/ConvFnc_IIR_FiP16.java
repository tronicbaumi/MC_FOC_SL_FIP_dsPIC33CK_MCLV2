...
public class ConvFnc_IIR_FiP16 extends JavaConversionFunction {
...
// USERCODE-BEGIN:ConvImplementationToMask                                                                              
        if (true) {
            throw new Exception(
                    "Implementation-to-Mask conversion not implemented for Block 'IIR', Implementation 'FiP16' in Library 'Filter' due to ambiguous parameters");
        }
