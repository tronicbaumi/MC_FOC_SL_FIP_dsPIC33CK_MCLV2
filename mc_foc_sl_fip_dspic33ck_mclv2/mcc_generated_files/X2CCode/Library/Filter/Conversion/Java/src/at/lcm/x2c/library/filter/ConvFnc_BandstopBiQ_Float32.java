...
public class ConvFnc_BandstopBiQ_Float32 extends JavaConversionFunction {
...
// USERCODE-BEGIN:ConvImplementationToMask                                                                              
        if (true) {
            throw new Exception(
                    "Implementation-to-Mask conversion not implemented for Block 'BandstopBiQ', Implementation 'Float32' in Library 'Filter' due to ambiguous parameters");
        }
