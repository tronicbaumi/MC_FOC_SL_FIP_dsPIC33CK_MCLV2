...
public class ConvFnc_LowpassBiQ_FiP32 extends JavaConversionFunction {
...
// USERCODE-BEGIN:ConvImplementationToMask                                                                              
        if (true) {
            throw new Exception(
                    "Implementation-to-Mask conversion not implemented for Block 'LowpassBiQ', Implementation 'FiP32' in Library 'Filter' due to ambiguous parameters");
        }
