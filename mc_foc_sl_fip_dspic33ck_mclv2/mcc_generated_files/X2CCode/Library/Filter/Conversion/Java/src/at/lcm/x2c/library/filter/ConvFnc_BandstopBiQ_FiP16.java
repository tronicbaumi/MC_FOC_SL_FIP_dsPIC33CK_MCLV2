...
public class ConvFnc_BandstopBiQ_FiP16 extends JavaConversionFunction {
...
// USERCODE-BEGIN:ConvImplementationToMask                                                                              
        if(true){
            throw new Exception("Implementation-to-Mask conversion not implemented for Block 'BandstopBiQ', Implementation 'FiP16' in Library 'Filter' due to ambiguous parameters");
        }
