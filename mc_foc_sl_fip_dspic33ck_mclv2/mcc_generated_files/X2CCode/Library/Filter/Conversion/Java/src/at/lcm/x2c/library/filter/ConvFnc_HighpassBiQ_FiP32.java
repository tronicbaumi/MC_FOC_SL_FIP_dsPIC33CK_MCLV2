...
public class ConvFnc_HighpassBiQ_FiP32 extends JavaConversionFunction {
...
// USERCODE-BEGIN:ConvImplementationToMask                                                                              
        if (true) {
            throw new Exception(
                    "Implementation-to-Mask conversion not implemented for Block 'HighpassBiQ', Implementation 'FiP32' in Library 'Filter' due to ambiguous parameters");
        }
