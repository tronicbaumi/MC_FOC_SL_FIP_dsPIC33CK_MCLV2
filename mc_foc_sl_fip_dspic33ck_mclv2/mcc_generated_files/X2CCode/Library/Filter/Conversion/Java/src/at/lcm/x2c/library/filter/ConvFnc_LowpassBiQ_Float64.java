...
public class ConvFnc_LowpassBiQ_Float64 extends JavaConversionFunction {
...
// USERCODE-BEGIN:ConvImplementationToMask                                                                              
        if (true) {
            throw new Exception(
                    "Implementation-to-Mask conversion not implemented for Block 'LowpassBiQ', Implementation 'Float64' in Library 'Filter' due to ambiguous parameters");
        }
