...
public class ConvFnc_HighpassBiQ_Float64 extends JavaConversionFunction {
...
// USERCODE-BEGIN:ConvImplementationToMask                                                                              
        if (true) {
            throw new Exception(
                    "Implementation-to-Mask conversion not implemented for Block 'HighpassBiQ', Implementation 'Float64' in Library 'Filter' due to ambiguous parameters");
        }
