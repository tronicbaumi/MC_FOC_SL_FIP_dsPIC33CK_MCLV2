...
public class ConvFnc_BandstopBiQ_Float64 extends JavaConversionFunction {
...
// USERCODE-BEGIN:ConvImplementationToMask                                                                              
        if (true) {
            throw new Exception(
                    "Implementation-to-Mask conversion not implemented for Block 'BandstopBiQ', Implementation 'Float64' in Library 'Filter' due to ambiguous parameters");
        }
