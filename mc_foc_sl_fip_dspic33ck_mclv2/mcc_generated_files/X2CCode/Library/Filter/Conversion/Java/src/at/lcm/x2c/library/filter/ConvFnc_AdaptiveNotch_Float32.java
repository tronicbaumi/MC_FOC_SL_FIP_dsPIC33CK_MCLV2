...
public class ConvFnc_AdaptiveNotch_Float32 extends JavaConversionFunction {
...
// USERCODE-BEGIN:ConvImplementationToMask                                                                              
        if (true) {
            throw new Exception("Implementation-to-Mask conversion not implemented for Block 'AdaptiveNotch', Implementation 'Float32' in Library 'Filter'");
        }
