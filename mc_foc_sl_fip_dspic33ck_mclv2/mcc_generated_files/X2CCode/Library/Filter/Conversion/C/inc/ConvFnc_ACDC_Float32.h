...
#ifndef CONVFNC_ACDC_FLOAT32_H
#define CONVFNC_ACDC_FLOAT32_H
...
typedef struct {
    float64 ts_fact;
} ACDC_FLOAT32_MASK_PARAM;

/* public prototypes */
uint8 ACDC_Float32_LoadMP(const ACDC_FLOAT32_MASK_PARAM *maskParam, uint8 data[], uint16* dataLen, uint16 maxSize);
uint8 ACDC_Float32_SaveMP(ACDC_FLOAT32 *block, ACDC_FLOAT32_MASK_PARAM *maskParam, const uint8 data[], uint16 dataLen);
