...
#ifndef CONVFNC_ACDC_FIP32_H
#define CONVFNC_ACDC_FIP32_H
...
typedef struct {
    float64 ts_fact;
} ACDC_FIP32_MASK_PARAM;

/* public prototypes */
uint8 ACDC_FiP32_LoadMP(const ACDC_FIP32_MASK_PARAM *maskParam, uint8 data[], uint16* dataLen, uint16 maxSize);
uint8 ACDC_FiP32_SaveMP(ACDC_FIP32 *block, ACDC_FIP32_MASK_PARAM *maskParam, const uint8 data[], uint16 dataLen);
