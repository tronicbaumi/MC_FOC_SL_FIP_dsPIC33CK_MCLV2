...
#ifndef CONVFNC_ACDC_FIP16_H
#define CONVFNC_ACDC_FIP16_H
...
typedef struct {
    float64 ts_fact;
} ACDC_FIP16_MASK_PARAM;

/* public prototypes */
uint8 ACDC_FiP16_LoadMP(const ACDC_FIP16_MASK_PARAM *maskParam, uint8 data[], uint16* dataLen, uint16 maxSize);
uint8 ACDC_FiP16_SaveMP(ACDC_FIP16 *block, ACDC_FIP16_MASK_PARAM *maskParam, const uint8 data[], uint16 dataLen);
