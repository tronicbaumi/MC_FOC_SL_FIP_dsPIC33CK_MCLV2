...
#include "ConvFnc_BandstopBiQ_Float64.h"
...
typedef struct {
    ...
    float64 a1;
    float64 a2;
} BANDSTOPBIQ_FLOAT64_IMPL_PARAM;
...
/** Private prototypes */
static uint8 convertM2I(const BANDSTOPBIQ_FLOAT64_MASK_PARAM *maskParam, BANDSTOPBIQ_FLOAT64_IMPL_PARAM *impParam, float_CoT ts);
 ...
 */
uint8 BandstopBiQ_Float64_LoadMP(const BANDSTOPBIQ_FLOAT64_MASK_PARAM *maskParam, uint8 data[], uint16* dataLen, uint16 maxSize)
{
    uint8 error = (uint8)0;
 ...
 */
uint8 BandstopBiQ_Float64_SaveMP(BANDSTOPBIQ_FLOAT64 *block, BANDSTOPBIQ_FLOAT64_MASK_PARAM *maskParam, const uint8 data[], uint16 dataLen)
{
    uint8 error = (uint8)0;
    ...
    else
    {
        ...
        BandstopBiQ_Float64_BackupMP(maskParam);
        ...
        error = BandstopBiQ_Float64_ConvertMP(block, maskParam);

        /** - Check for errors during execution of save function */
        if (error != 0)
        {
            /* Restore old mask parameter */
            BandstopBiQ_Float64_RestoreMP(maskParam);
        }
 ...
 */
uint8 BandstopBiQ_Float64_InitMP(BANDSTOPBIQ_FLOAT64 *block, const BANDSTOPBIQ_FLOAT64_MASK_PARAM *maskParam)
{
    uint8 error = (uint8)0;
    float_CoT block_ts;

    BANDSTOPBIQ_FLOAT64_IMPL_PARAM *implParam = (BANDSTOPBIQ_FLOAT64_IMPL_PARAM*)ImplParamBuffer;
    ...
    SaveFncDataBuffer[24] = (uint8)((*(uint64*)&(implParam->a1)) & 0x00000000000000FF);
    SaveFncDataBuffer[25] = (uint8)((*(uint64*)&(implParam->a1) >> 8) & 0x00000000000000FF);
    SaveFncDataBuffer[26] = (uint8)((*(uint64*)&(implParam->a1) >> 16) & 0x00000000000000FF);
    SaveFncDataBuffer[27] = (uint8)((*(uint64*)&(implParam->a1) >> 24) & 0x00000000000000FF);
    SaveFncDataBuffer[28] = (uint8)((*(uint64*)&(implParam->a1) >> 32) & 0x00000000000000FF);
    SaveFncDataBuffer[29] = (uint8)((*(uint64*)&(implParam->a1) >> 40) & 0x00000000000000FF);
    SaveFncDataBuffer[30] = (uint8)((*(uint64*)&(implParam->a1) >> 48) & 0x00000000000000FF);
    SaveFncDataBuffer[31] = (uint8)((*(uint64*)&(implParam->a1) >> 56) & 0x00000000000000FF);
    SaveFncDataBuffer[32] = (uint8)((*(uint64*)&(implParam->a2)) & 0x00000000000000FF);
    SaveFncDataBuffer[33] = (uint8)((*(uint64*)&(implParam->a2) >> 8) & 0x00000000000000FF);
    SaveFncDataBuffer[34] = (uint8)((*(uint64*)&(implParam->a2) >> 16) & 0x00000000000000FF);
    SaveFncDataBuffer[35] = (uint8)((*(uint64*)&(implParam->a2) >> 24) & 0x00000000000000FF);
    SaveFncDataBuffer[36] = (uint8)((*(uint64*)&(implParam->a2) >> 32) & 0x00000000000000FF);
    SaveFncDataBuffer[37] = (uint8)((*(uint64*)&(implParam->a2) >> 40) & 0x00000000000000FF);
    SaveFncDataBuffer[38] = (uint8)((*(uint64*)&(implParam->a2) >> 48) & 0x00000000000000FF);
    SaveFncDataBuffer[39] = (uint8)((*(uint64*)&(implParam->a2) >> 56) & 0x00000000000000FF);

    /** - Execute save function of block */
    error = BandstopBiQ_Float64_Save(block, SaveFncDataBuffer, 40);
 ...
 */
uint8 BandstopBiQ_Float64_ConvertMP(BANDSTOPBIQ_FLOAT64 *block, BANDSTOPBIQ_FLOAT64_MASK_PARAM *maskParam)
{
    uint8 error;
    float_CoT block_ts;
    BANDSTOPBIQ_FLOAT64_IMPL_PARAM *implParam = (BANDSTOPBIQ_FLOAT64_IMPL_PARAM*)ImplParamBuffer;
 ...
 * @return Nothing
 */
void BandstopBiQ_Float64_BackupMP(BANDSTOPBIQ_FLOAT64_MASK_PARAM* maskParam)
{
 ...
 * @return Nothing
 */
void BandstopBiQ_Float64_RestoreMP(BANDSTOPBIQ_FLOAT64_MASK_PARAM* maskParam)
{
