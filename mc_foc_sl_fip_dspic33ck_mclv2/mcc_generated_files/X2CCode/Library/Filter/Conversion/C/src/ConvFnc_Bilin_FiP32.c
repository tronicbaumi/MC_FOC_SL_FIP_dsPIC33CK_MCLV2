...
typedef struct {
    ...
    int8 sfrb1;
    int8 sfra1;
} BILIN_FIP32_IMPL_PARAM;

/** Private prototypes */
static uint8 convertM2I(const BILIN_FIP32_MASK_PARAM *maskParam, BILIN_FIP32_IMPL_PARAM *impParam, float_CoT ts);
...
/* USERCODE-BEGIN:Conversion                                                                                          */
    ...
    else
    {
        ...
        sfrb0 = getQFormat(b0, BITS);
        sfrb1 = getQFormat(b1, BITS);
        sfra1 = getQFormat(a1, BITS);
...
uint8 Bilin_FiP32_SaveMP(BILIN_FIP32 *block, BILIN_FIP32_MASK_PARAM *maskParam, const uint8 data[], uint16 dataLen)
{
    ...
    else
    {
        ...
        Bilin_FiP32_BackupMP(maskParam);
...
uint8 Bilin_FiP32_InitMP(BILIN_FIP32 *block, const BILIN_FIP32_MASK_PARAM *maskParam)
{
    ...
    BILIN_FIP32_IMPL_PARAM *implParam = (BILIN_FIP32_IMPL_PARAM*)ImplParamBuffer;
    ...
    SaveFncDataBuffer[8] = (uint8)(implParam->a1 & 0x000000FF);
    SaveFncDataBuffer[9] = (uint8)((implParam->a1 >> 8) & 0x000000FF);
    SaveFncDataBuffer[10] = (uint8)((implParam->a1 >> 16) & 0x000000FF);
    SaveFncDataBuffer[11] = (uint8)((implParam->a1 >> 24) & 0x000000FF);
    SaveFncDataBuffer[12] = (uint8)implParam->sfrb0;
    SaveFncDataBuffer[13] = (uint8)implParam->sfrb1;
    SaveFncDataBuffer[14] = (uint8)implParam->sfra1;

    /** - Execute save function of block */
    error = Bilin_FiP32_Save(block, SaveFncDataBuffer, 15);
