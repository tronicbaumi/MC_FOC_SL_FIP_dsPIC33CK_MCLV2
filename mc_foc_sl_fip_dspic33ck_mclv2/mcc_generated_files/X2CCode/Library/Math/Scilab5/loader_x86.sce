...
//
[bOK, ilib] = c_link('x2c_Acos_FiP8_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_Acos_FiP16_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_Acos_FiP32_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_Acos_Float32_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_Acos_Float64_C');
if bOK then
  ulink(ilib);
end
//
...
//
[bOK, ilib] = c_link('x2c_Asin_FiP8_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_Asin_FiP16_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_Asin_FiP32_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_Asin_Float32_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_Asin_Float64_C');
if bOK then
  ulink(ilib);
end
//
...
//
[bOK, ilib] = c_link('x2c_Exp_Float32_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_Exp_Float64_C');
if bOK then
  ulink(ilib);
end
//
...
//
[bOK, ilib] = c_link('x2c_Sign_Float32_C');
if bOK then
  ulink(ilib);
end
//
[bOK, ilib] = c_link('x2c_Sign_Float64_C');
if bOK then
  ulink(ilib);
end
//
